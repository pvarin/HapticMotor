...
class bootloadergui:
    ...
    def __init__(self):
        ...
        self.filemenu.add_command(label='Import Hex...', command=self.import_hex, accelerator='Command-i')
        self.root.bind('<Command-i>', self.import_hex)
        self.filemenu.add_command(label='Export Hex...', command=self.export_hex, accelerator='Command-e')
        self.root.bind('<Command-e>', self.export_hex)
        ...
        self.bootloadermenu.add_command(label='Write Device', command=self.write_device, accelerator='Command-w')
        self.root.bind('<Command-w>', self.write_device)
        ...
        self.root.bind('<Command-c>', self.connect)
        self.bootloadermenu.add_command(label='Disconnect/Run', command=self.disconnect, accelerator='Command-d')
        self.root.bind('<Command-d>', self.disconnect)
    ...
    def write_device(self, event=None):
    ...
    def import_hex(self, event=None):
    ...
    def export_hex(self, event=None):
